...
public class Sha1withRSAUtil_bak {
    ...
    /** 指定公钥存放文件 */
    private static String PUBLIC_KEY_FILE = "d:/PublicKey.txt";
    /** 指定私钥存放文件 */
    private static String PRIVATE_KEY_FILE = "d:/PrivateKey.txt";
    ...
    public static void main(String[] args) {
        String prkey = getprivatekey();
        String pukey = getpublickey();
        System.out.println(prkey);
        System.out.println(pukey);
        /*try {
            Sha1withRSAUtil.generateKeyPair();
        } catch (Exception e) {
            e.printStackTrace();
        }*/
        /*try {
